...
routes.post("/create", (req, res) => UserController.create_user(req, res));
...
routes.post("/:user_id/product-list/add-product-quantity/:product_id", auth, (req, res) => ProductListController.add_product_quantity(req, res))
