  ...
  async add_product_quantity(req, res) {
    ...
    try {
      ...
      const product_in_list = await sequelize.query(
        "UPDATE public.\"ProductList\" SET quantity = " + 4
        + "where public.\"ProductList\".\"user_id\"= " + 1
        + " and \"ProductList\".\"product_id\"= " + 6,
      ...
      const new_quantity = await sequelize.query(
        "SELECT quantity FROM public.\"ProductList\" where public.\"ProductList\".\"user_id\"= " + 1
        + " and \"ProductList\".\"product_id\"= " + 6,
        { model: Product_list, mapToModel: true }
      )
